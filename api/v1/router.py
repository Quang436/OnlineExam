...
from app.api.v1.endpoints.ai_parser import router as ai_parser_router
...
api_v1_router.include_router(users_router, prefix="/users", tags=["Quản lý Người Dùng & Giáo Viên"])
api_v1_router.include_router(ai_parser_router, prefix="/ai", tags=["AI File Parser"])
...
api_v1_router.include_router(stats_router, prefix="/stats", tags=["Tổng Sắp Radar Admin"])